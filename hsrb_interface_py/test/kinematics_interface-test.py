...
class KinematicsInterfaceTest(unittest.TestCase):
    ...
    def test_normal(self):
        """Test normal case"""
        result = self._kinematics.calculate_angles([1.0, 0.0, 0.0],
    ...
    def test_invalid_point_length(self):
        ...
        assert_raises(ValueError, self._kinematics.calculate_angles,
                      [], 'head_rgbd_sensor_link')
        assert_raises(ValueError, self._kinematics.calculate_angles,
    ...
    def test_uncomputable_point(self):
        ...
        result = self._kinematics.calculate_angles([0.0, 0.0, 0.757],
                                                   'head_rgbd_sensor_link')
        eq_(len(result), 0)

    def test_invalid_frame(self):
        """A frame name which is not in robot model is not accepted."""
        assert_raises(RuntimeError, self._kinematics.calculate_angles,
